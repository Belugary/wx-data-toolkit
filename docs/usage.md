...
# 2. 注册到 Claude Code
claude mcp add wechat -- python C:\path\to\wechat-decrypt\wxdec\mcp_server.py
...
前置条件：需要先运行 `python -m wxdec.find_all_keys` 提取密钥，并配置 `config.json`。详见 [README.md](../README.md)。
