...
import io
import os, sys, json, time, sqlite3, tempfile, hashlib, atexit, re, threading
import glob
import wave
...
from wxdec.db_core import (
    PAGE_SZ, KEY_SZ, SALT_SZ, RESERVE_SZ, SQLITE_HDR, WAL_HEADER_SZ, WAL_FRAME_HEADER_SZ,
...
from wxdec.contact import (
    ...
    _get_contact_db_path, _extract_pb_field_30, _load_contact_tags,
    resolve_username, _get_self_username,
)
from wxdec.msg_format import (
    _XML_UNSAFE_RE, _XML_PARSE_MAX_LEN, _RECORD_XML_PARSE_MAX_LEN,
    _MD5_VERIFY_MAX_SIZE, _MD5_CHUNK_SIZE,
    _zstd_dctx,
    format_msg_type, _split_msg_type,
    _decompress_content, _parse_message_content, _collapse_text,
    _load_name2id_maps, _display_name_for_username,
    _resolve_sender_label, _resolve_quote_sender_label,
    _safe_basename, _path_under_root, _md5_file_chunked,
    _parse_xml_root, _parse_int, _parse_app_message_outer,
    _format_app_message_text,
    _format_record_dataitem, _format_record_message_text,
    _RECORD_MAX_ITEMS, _RECORD_MAX_LINE_LEN,
    _RECORD_BINARY_SUBDIR, _RECORD_DATATYPE_LABEL,
    _TRANSFER_PAYSUBTYPE_LABEL,
    _extract_refer_info, _summarize_refer_content, _format_refer_message_text,
    _REFER_INNER_TYPE_LABEL, _INNER_APPMSG_TYPE_LABEL,
    _extract_transfer_info, _format_transfer_message_text,
    _format_voip_message_text,
    _format_message_text,
)
from wxdec.msg_query import (
    _QUERY_LIMIT_MAX, _HISTORY_QUERY_BATCH_SIZE,
    _is_safe_msg_table_name, _find_msg_table_for_user, _find_msg_tables_for_user,
    _validate_pagination, _parse_time_value, _parse_time_range,
    _build_message_filters, _query_messages,
    _resolve_chat_context, _resolve_chat_contexts, _normalize_chat_names,
    _format_history_lines, _build_search_entry, _build_history_line,
    _get_chat_message_tables, _iter_table_contexts,
    _candidate_page_size, _message_query_batch_size, _history_query_batch_size,
    _page_ranked_entries,
    _collect_chat_history_lines, _collect_chat_search_entries,
    _load_search_contexts_from_db, _collect_search_entries,
    _page_search_entries, _search_single_chat, _search_multiple_chats, _search_all_messages,
)
